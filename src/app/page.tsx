                ...
                <div>
                  <div className="flex items-center justify-between text-gray-100">
                    ...
                    <div className="flex items-center">
                      {/* button delete */}
                      <button onClick={() => handleDelete(note._id)} className="w-8 h-8 rounded-full bg-red-300 text-gray-800  flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-offset-2  focus:ring-black hover:bg-red-500 duration-500" aria-label="delete note" role="button">
