...
export default function Home() {
  ...
  const fetchData = async () => {
    try {
      const response: any = await fetch("http://localhost:3000/api/notes");
        ...
        <div className="mx-auto container py-10 px-6">
          <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <div className="rounded">
              ...
              {/* map */}
              <div className="w-full h-64 flex flex-col justify-between bg-gray-800 border-gray-700 rounded-lg border mb-6 py-5 px-4">
                <div>
                  {/* title */}
                  <h4 className="text-gray-100 font-bold mb-3">13 things to work on</h4>
                  {/* description */}
                  <p className="text-gray-100 text-sm">Our interior design experts work with you to create the space that you have been dreaming about.</p>
                </div>
                <div>
